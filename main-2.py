...
training_args = TrainingArguments(
    ...
    num_train_epochs=3,
    save_steps=1000,
    eval_strategy="steps",  # Evaluate every 'eval_steps' instead of per epoch
...
# Step 9: Initialize Trainer with Early Stopping Callback
trainer = Trainer(
    model=peft_model,
    args=training_args,
    ...
    callbacks=[EarlyStoppingCallback(early_stopping_patience=7)]  # Stops training if loss doesn't improve for 7 eval steps
)
